...
H = [
    ...
    ("A10", "A", "Exhaust-treatment reagent: nitrogen added to remove nitrogen",
     ...
     "and water and acts within hours. Anything reaching ground as liquid — "
     "spillage at filling points, tank rinsing, disposal — is fertiliser arriving "
     "by that route, with no combustion involved at all. That is a second pathway "
     "entirely separate from slip, and neither is measured.\n\nIn the exhaust the "
     "decomposition is two steps, and the failure sits in the second: thermolysis "
     "gives ammonia plus isocyanic acid, then hydrolysis on the catalyst gives a "
     "second ammonia and CO2. If the catalyst is cold the isocyanic acid "
     "polymerises instead — biuret, cyanuric acid, melamine — which is what urea "
     "deposits in an exhaust system are made of. The technology works, and the "
     "point here is not that it fails. It is that **a large mass of reactive nitrogen is "

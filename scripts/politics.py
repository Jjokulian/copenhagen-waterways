...
def render(d, a):
    ...
    w("Some of that is real and some of it is an artefact of the method. Ministries "
      ...
      "is under-represented here, and that the under-representation is worst for the "
      "two of the three parties that voted against.** Dansk Folkeparti and Borgernes "
      "Parti voted "

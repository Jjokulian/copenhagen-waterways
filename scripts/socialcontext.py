...
| 2026-09-01 | {C("C-IN-T-TILLAEG", "A *tillægsaftale* exempting land that grows vegetables from the new nitrogen regulation model, temporarily, in its first year")} | aftale |
...
def sec_gaps(d):
    ...
    rows = "\n".join([
        ...
        row("**The braklægningspunkt**", "C-IN-G-BRAK", "**Set per catchment, not as one number.** The June 2025 partial agreement fixes it for each catchment at the regulation under which that catchment can just meet its discharge limit growing spring barley with catch crops on all its farmland. The figures per catchment had not been published: the ministry's assessment of July 2026 says they were still to be computed.", "The implementing order's annex with each catchment's point, once issued."),
        row("**Compensation and transition rates**", "C-IN-G-RATES", "**Published for permanent extensification only**, read from the pinned BEK 130/2026 §18 in section 6. For the new regulation, the decision paper of June 2026 sets a financing frame, not rates per hectare, and the ministry's assessment of July 2026 says the final rates were still to be computed.", "The compensation order, once issued."),
        ...
        row("**The *bemærkninger* to LOV 759**", "C-IN-G-REMARKS", "**Pinned, with the bill as introduced (`L 5`).** The enacted text is quoted from LOV 759 — §6, §11, §57 and §65; the remarks describe a holding's quota as the sum of its fields' quotas. What sets each field's quota is delegated to the implementing orders.", "The implementing orders, once issued."),

...
<span class="claim" data-claim="C-DQ-U-GENERATED">*Generated by `scripts/unlock.py` from `data_sources.json`, `data_sources_2.json` and `data_sources_3.json` and the slots the script defines.*</span><sup class="claim-mark">[†](CLAIMS.md#C-DQ-U-GENERATED "What this claim rests on")</sup> *Do not hand-edit.*
...
<span class="claim" data-claim="C-DQ-H-INTRO">Some of what this page once listed as out of reach is held. The sibling project danish-livestock fetched the herd, company and field-parcel registers from their open, first-party sources, and this project reads its files in place:</span><sup class="claim-mark">[†](CLAIMS.md#C-DQ-H-INTRO "What this claim rests on")</sup>

- <span class="claim" data-claim="C-DQ-H-CHR">`chr_2024.json` - every livestock site in the herd register, with the business that runs it, its species and its animal units; read by `scripts/livestock_baskets.py` and `scripts/socialcontext.py`</span><sup class="claim-mark">[†](CLAIMS.md#C-DQ-H-CHR "What this claim rests on")</sup>
- <span class="claim" data-claim="C-DQ-H-CVR">`cvr_raw.jsonl` - the CVR register's record for each of those businesses; `scripts/socialcontext.py` keeps four company fields and no person</span><sup class="claim-mark">[†](CLAIMS.md#C-DQ-H-CVR "What this claim rests on")</sup>
- <span class="claim" data-claim="C-DQ-H-ACCOUNTS">`cvr_financials.json` - the annual accounts those businesses filed; read by `scripts/socialcontext.py`</span><sup class="claim-mark">[†](CLAIMS.md#C-DQ-H-ACCOUNTS "What this claim rests on")</sup>
- <span class="claim" data-claim="C-DQ-H-LAND">`land_by_cvr.json` - declared field-parcel hectares per business, from the field-parcel register; read by `scripts/socialcontext.py`</span><sup class="claim-mark">[†](CLAIMS.md#C-DQ-H-LAND "What this claim rests on")</sup>

<span class="claim" data-claim="C-DQ-H-MANURE">`scripts/manure.py` fetches the herd and field-parcel registers itself, from the same open source the sibling project found.</span><sup class="claim-mark">[†](CLAIMS.md#C-DQ-H-MANURE "What this claim rests on")</sup> <span class="claim" data-claim="C-DQ-H-COPERNICUS">The Copernicus Marine and Copernicus Data Space credentials are held as well, and the fetch queue counts their entries as held, in the table below.</span><sup class="claim-mark">[†](CLAIMS.md#C-DQ-H-COPERNICUS "What this claim rests on")</sup>
...
**Unlocks.** <span class="claim" data-claim="C-DQ-S-CVR">Turning a CVR number into who and where. For this project's joins the register's own records are already held: the sibling project danish-livestock has an answered record for [16,449](SOURCES.md#F-507efc40ea) of the [16,449](SOURCES.md#F-88d706031a) CVR numbers behind a livestock site and [26,921](SOURCES.md#F-bd2dc3f8ee) of the [26,922](SOURCES.md#F-02fa59aaa0) field-parcel operators, and `scripts/socialcontext.py` keeps four company fields from each record and no person. The bulk register would add the companies outside these joins.</span><sup class="claim-mark">[†](CLAIMS.md#C-DQ-S-CVR "What this claim rests on")</sup>

**Shape.** `one JSON object per line, must carry cvr and one of {name, industrycode, kommune}`

**Who holds it.** <span class="claim" data-claim="C-DQ-W-CVR">Erhvervsstyrelsen. Its documented bulk API issues credentials on written application; the register's own public site answers one company at a time without a key, which is how the sibling project fetched these, as its notes on the registers record.</span><sup class="claim-mark">[†](CLAIMS.md#C-DQ-W-CVR "What this claim rests on")</sup>
...
<span class="claim" data-claim="C-DQ-U-TABLE">Every entry of `data_sources.json`, `data_sources_2.json` and `data_sources_3.json` that the fetch queue does not class as open, ordered by tier, then by how many hypotheses the entry names, with every hypothesis it names.</span><sup class="claim-mark">[†](CLAIMS.md#C-DQ-U-TABLE "What this claim rests on")</sup> <span class="claim" data-claim="C-DQ-U-TIERS">*Held* means behind a credential this project holds - ODA, Dataforsyningen, Copernicus Marine, Copernicus Data Space - or already on this machine; *account* means a registration, an account, a login or a token the fetch queue does not count as held; *blocked* means the access text says it is closed or unverified, or matches no tier word.</span><sup class="claim-mark">[†](CLAIMS.md#C-DQ-U-TIERS "What this claim rests on")</sup>
...
| `held` | **LOCAL-ODA-CTD** | [Z4](HYPOTHESES.md "Temperature: window, and rate") [W6](HYPOTHESES.md "Change outrunning acclimation") [K10](HYPOTHESES.md "Salinity change and osmotic cost") [C1](hypodrafts/C1.md "Stratification strength") [C2](HYPOTHESES.md "Wind work") [O1](HYPOTHESES.md "Oxygen deficit") [Z1](HYPOTHESES.md "Light: too little, and too much") | ON DISK - the full ODA marine CTD record |
| `held` | **LOCAL-CMEMS-PFT** | [K1](hypodrafts/K1.md "Silicon depletion and the diatom-to-flagellate shift") [K2](HYPOTHESES.md "Stoichiometric imbalance decides who grows") [F7](HYPOTHESES.md "Harmful algal blooms specifically") [W3](HYPOTHESES.md "Phenological mismatch") [K13](HYPOTHESES.md "Food depletion for filter feeders and larvae") [A9](HYPOTHESES.md "Nitrogen fixation") | ON DISK - CMEMS Baltic ocean-colour phytoplankton functional types, daily `1` km |
| `held` | **LOCAL-CTD-OPTICAL** | [Z2](HYPOTHESES.md "Light quality, not quantity: browning") [Z8](hypodrafts/Z8.md "The attenuation budget is never partitioned") [Z10](HYPOTHESES.md "Mineral plumes from works") [O4](HYPOTHESES.md "Turbidity and phytoplankton biomass") [R5](HYPOTHESES.md "The terminal electron acceptor cascade, and why salt changes it") [E12](HYPOTHESES.md "Hydrogen sulphide toxicity") | ON DISK - the optical and sulphide parameters hiding inside the CTD file |
...
| `held` | **CMEMS-BAL-BGC** | [O1](HYPOTHESES.md "Oxygen deficit") [C4](hypodrafts/C4.md "Baltic inflow events") [A1](hypodrafts/A1.md "Danish land-based nitrogen load") [A5](HYPOTHESES.md "Advected nutrients from outside Denmark") [O4](HYPOTHESES.md "Turbidity and phytoplankton biomass") | Copernicus Marine Baltic Sea Biogeochemistry Reanalysis |
| `held` | **CMEMS-BAL-PHY** | [C1](hypodrafts/C1.md "Stratification strength") [C3](HYPOTHESES.md "Residence time") [C4](hypodrafts/C4.md "Baltic inflow events") [C6](hypodrafts/C6.md "Water temperature and solubility") [G1](hypodrafts/G1.md "Warming") | Copernicus Marine Baltic Sea Physics Reanalysis |
| `held` | **LOCAL-GEUS-SEABED** | [L6](HYPOTHESES.md "The degraded bed is classified as its own habitat type") [D10](HYPOTHESES.md "Winnowing and armouring") [R7](HYPOTHESES.md "Estuarine flocculation deposits river carbon at the coast") [S5](HYPOTHESES.md "Buffering scales with the volume of reactive medium") [Z5](HYPOTHESES.md "Hydrodynamic energy has a floor as well as a ceiling") | ON DISK - GEUS seabed sediment map, and how coarse it is |
| `held` | **LOCAL-ODA-LYS** | [K11](HYPOTHESES.md "Light as a depleted resource") [Z1](HYPOTHESES.md "Light: too little, and too much") [Z8](hypodrafts/Z8.md "The attenuation budget is never partitioned") [O4](HYPOTHESES.md "Turbidity and phytoplankton biomass") [T1](HYPOTHESES.md "Sulphide intrusion, gated by light") | ON DISK - the ODA light-attenuation record, 1980-2026 |
| `held` | **LOCAL-ODA-STATIONS** | [L3](hypodrafts/L3.md "The trend depends on the start year") [L5](HYPOTHESES.md "The reference sites are not references") [W8](HYPOTHESES.md "Whoever founds the community keeps it") [I3](hypodrafts/I3.md "Changing sampling frequency and season") [D9](HYPOTHESES.md "Fertility islands lost to homogenisation") | ON DISK - the ODA marine Observationssted register, `798,574` sites |
...
| `held` | **ODA-CTD-CAST-FREQUENCY** | [Z4](HYPOTHESES.md "Temperature: window, and rate") [W6](HYPOTHESES.md "Change outrunning acclimation") [W3](HYPOTHESES.md "Phenological mismatch") [I3](hypodrafts/I3.md "Changing sampling frequency and season") [L3](hypodrafts/L3.md "The trend depends on the start year") | How often the Danish marine CTD network is actually visited - the constraint on every rate |
...
| `held` | **LOCAL-CMEMS-KD490** | [Z1](HYPOTHESES.md "Light: too little, and too much") [Z8](hypodrafts/Z8.md "The attenuation budget is never partitioned") [K11](HYPOTHESES.md "Light as a depleted resource") [O4](HYPOTHESES.md "Turbidity and phytoplankton biomass") | ON DISK - CMEMS Baltic ocean-colour transparency, Kd490, daily `1` km |
| `held` | **LOCAL-MFS-TILSTAND** | [E15](HYPOTHESES.md "Total biocide load, whatever its source") [E16](HYPOTHESES.md "Conserved targets: 'selective' is a claim about dose") [E13](HYPOTHESES.md "Biocides that remove the decomposers themselves") [L5](HYPOTHESES.md "The reference sites are not references") | ON DISK - Danish river-basin-specific-pollutant monitoring stations, and the marine hole i |
| `held` | **LOCAL-RAASTOF-KLAP** | [Z10](HYPOTHESES.md "Mineral plumes from works") [K12](HYPOTHESES.md "Loss of habitat-forming structure") [D4](HYPOTHESES.md "Sand and gravel extraction") [D3](HYPOTHESES.md "Dredged-material dumping") | ON DISK - Danish marine raw-material extraction areas and dumping sites |
| `held` | **LOCAL-WFD-TYPOLOGY** | [L5](HYPOTHESES.md "The reference sites are not references") [L2](HYPOTHESES.md "The reference is a model output treated as a fact") [L6](HYPOTHESES.md "The degraded bed is classified as its own habitat type") [I4](HYPOTHESES.md "Changing indicator definition") | ON DISK - the `123` Danish marine water bodies and their WFD types |
...
| `held` | **LOCAL-ODA-MAALEDYBDE-TRUNCATED** | [K11](HYPOTHESES.md "Light as a depleted resource") [L3](hypodrafts/L3.md "The trend depends on the start year") [Z1](HYPOTHESES.md "Light: too little, and too much") | ON DISK BUT TRUNCATED - the ODA Secchi extract is the two-year default window, not the rec |
...
| `held` | **CMEMS-BAL-WAV** | [D7](hypodrafts/D7.md "Storm-driven resuspension") [O2](HYPOTHESES.md "Fedtemøg") | Copernicus Marine Baltic Sea Wave Reanalysis |
| `held` | **CMEMS-NWS-WAV** | [D7](hypodrafts/D7.md "Storm-driven resuspension") [O2](HYPOTHESES.md "Fedtemøg") | Copernicus Marine North-West Shelf Wave Reanalysis |
| `held` | **CDSE-SENTINEL1** | [J6](HYPOTHESES.md "Oil and hydrocarbon films") | `Sentinel-1` GRD SAR over Danish waters, Copernicus Data Space Ecosystem |
...
| `blocked` | **W1-W2-W5-W8-GAP** | [W1](HYPOTHESES.md "Propagule supply and connectivity") [W2](HYPOTHESES.md "Settlement cue failure") [W5](HYPOTHESES.md "Recovery slower than the disturbance interval") [W6](HYPOTHESES.md "Change outrunning acclimation") [W8](HYPOTHESES.md "Whoever founds the community keeps it") [T10](HYPOTHESES.md "Removing an organism whose role is unknown is not neutral") | The renewal measurements Denmark does not make |
| `blocked` | **Z1-Z3-Z5-Z9-Z11-GAP** | [Z1](HYPOTHESES.md "Light: too little, and too much") [Z3](HYPOTHESES.md "Photoperiod and timing as a cue") [Z4](HYPOTHESES.md "Temperature: window, and rate") [Z5](HYPOTHESES.md "Hydrodynamic energy has a floor as well as a ceiling") [Z9](HYPOTHESES.md "Epiphyte shading, which bypasses the water column") [Z11](HYPOTHESES.md "The weakened host") | The physical-window measurements Denmark does not make |
...
| `blocked` | **E13-E16-E19-GAP** | [E13](HYPOTHESES.md "Biocides that remove the decomposers themselves") [E16](HYPOTHESES.md "Conserved targets: 'selective' is a claim about dose") [E19](HYPOTHESES.md "The sentinel species decides what is detectable") [E17](HYPOTHESES.md "The microbiome is the exposed organ") | Fungicides in sediment, mechanism-matched marine endpoints, and a local sentinel-species p |
...
| `blocked` | **DTU-MOLLUSC-NRL** | [F12](HYPOTHESES.md "The micropathogens nobody catalogues") [T3](HYPOTHESES.md "Wasting disease with stress-modulated virulence") [T8](HYPOTHESES.md "Anaerobic conditions select the pathogens") | Denmark's National Reference Laboratory for mollusc diseases |
| `blocked` | **E15-PESTICIDE-USE-GAP** | [E15](HYPOTHESES.md "Total biocide load, whatever its source") [E13](HYPOTHESES.md "Biocides that remove the decomposers themselves") [E16](HYPOTHESES.md "Conserved targets: 'selective' is a claim about dose") | Danish pesticide use at any spatial unit finer than the nation - unresolved |
| `blocked` | **GEUS-VAP** | [E15](HYPOTHESES.md "Total biocide load, whatever its source") [E13](HYPOTHESES.md "Biocides that remove the decomposers themselves") [S1](HYPOTHESES.md "Retention is a property of the medium and varies by an order of magnitude") | VAP - Varslingssystemet for udvaskning af pesticider til grundvand |
...
| `blocked` | **A10-NH3-GAP** | [A10](HYPOTHESES.md "Exhaust-treatment reagent: nitrogen added to remove nitrogen") [A3](HYPOTHESES.md "Atmospheric deposition on the sea surface") | Danish roadside and network ammonia measurement - not found as open data |
...
| `blocked` | **R11-MARINE-FUNGI-GAP** | [R11](HYPOTHESES.md "Marine fungi, the decomposers nobody counts") [E13](HYPOTHESES.md "Biocides that remove the decomposers themselves") | Marine fungi in Denmark - structurally absent from the sequence archives |
...
| `blocked` | **VETSTAT** | [E14](HYPOTHESES.md "Veterinary antiparasitics in manure") [E15](HYPOTHESES.md "Total biocide load, whatever its source") | VetStat - Danish national veterinary medicine consumption statistics |
| `blocked` | **Z2-Z8-CDOM-GAP** | [Z2](HYPOTHESES.md "Light quality, not quantity: browning") [Z8](hypodrafts/Z8.md "The attenuation budget is never partitioned") | Spectral attenuation and CDOM in Danish water - one fjord, and one sensor since 2021 |
| `blocked` | **Z7-CABLES-GAP** | [Z7](HYPOTHESES.md "Electromagnetic fields") [C8](HYPOTHESES.md "Constructed change to circulation") | Danish submarine cable routes with energisation dates - no national layer found |

...
**Not in HYPOTHESES.md.** This test came out of a question about A1 and is written here
...
- **1999** — the nitrogen norm was cut 10%, dropping the quota ~40,000 t N, while grass
  norms changed simultaneously, raising it ~15,000 t N. DCE's own report calls the
...
| **estuary total N, measured** | national monitoring 1989–, 12–46 samples/yr | the independent terminal series |
| stream N, gauged fraction | fortnightly total-N × daily discharge | measured; 22–87% of area by catchment |
...
- **Gauged-fraction stratification.** The circular component scales with the modelled
  share, so the effect should be **strongest at Isefjord (22% gauged) and weakest at
  Randers (87%)**. That gradient is a prediction no rival explanation makes.
...
fall. Windolf's measured estuary nitrogen fell 24–62% regardless, and the intercept of

...
**44 water bodies covering 24,605 km² (56% of Danish sea) carry neither a fitted model nor a single repeated marine observation** in this open-data set. They still receive a requirement.

...
- <span class="claim" data-claim="C-SS-T-B-CSO">**Instrumenting the [13](SOURCES.md#F-aee8a1ff8a) largest overflow structures**: flow rather than event counts, at the structures that hold [24](SOURCES.md#F-c2c8fe6829)% of the volume reported by the [1,328](SOURCES.md#F-66b55fdb81) that report one.</span><sup class="claim-mark">[†](CLAIMS.md#C-SS-T-B-CSO "What this claim rests on")</sup>

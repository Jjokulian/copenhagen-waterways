...
| **we know it's missing** | **known unknown** — the [93](SOURCES.md#F-000ac8d87b) gated sources in [If you have data access we don't](IF_YOU_HAVE_THE_DATA.md), [10](SOURCES.md#F-fe0618057d) of them with a slot the analysis is already written against | **unknown unknown** — measurements nobody makes and nobody has thought to want |
